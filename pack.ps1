...
Copy-Item "bin\innative.*" -Destination "innative-windows-sdk-x64\bin\"
Copy-Item "bin\innative-d.*" -Destination "innative-windows-sdk-x64\bin\"
Copy-Item "bin\innative-s.*" -Destination "innative-windows-sdk-x64\bin\"
Copy-Item "bin\innative-s-d.*" -Destination "innative-windows-sdk-x64\bin\"
Copy-Item "bin\innative-env.*" -Destination "innative-windows-sdk-x64\bin\"
Copy-Item "bin\innative-env-d.*" -Destination "innative-windows-sdk-x64\bin\"
...
Copy-Item "spec\test\core\*" -Destination "innative-windows-sdk-x64\spec\test\core\" 
...
Copy-Item "bin32\innative.*" -Destination "innative-windows-sdk-x86\bin\"
Copy-Item "bin32\innative-d.*" -Destination "innative-windows-sdk-x86\bin\"
Copy-Item "bin32\innative-s.*" -Destination "innative-windows-sdk-x86\bin\"
Copy-Item "bin32\innative-s-d.*" -Destination "innative-windows-sdk-x86\bin\"
Copy-Item "bin32\innative-env.*" -Destination "innative-windows-sdk-x86\bin\"
Copy-Item "bin32\innative-env-d.*" -Destination "innative-windows-sdk-x86\bin\"
...
Copy-Item "spec\test\core\*" -Destination "innative-windows-sdk-x86\spec\test\core\" 

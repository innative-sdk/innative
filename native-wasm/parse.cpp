...
namespace innative {
  IR_FORCEINLINE IR_ERROR ParseVarUInt32(Stream& s, varuint32& target) { IR_ERROR err; target = static_cast<varuint32>(DecodeLEB128(s, err, 32, false)); return err; }
  IR_FORCEINLINE IR_ERROR ParseVarSInt7(Stream& s, varsint7& target) { IR_ERROR err; target = static_cast<varsint7>(DecodeLEB128(s, err, 7, true)); return err; }
  IR_FORCEINLINE IR_ERROR ParseVarUInt7(Stream& s, varuint7& target) { IR_ERROR err; target = static_cast<varuint7>(DecodeLEB128(s, err, 7, false)); return err; }
  IR_FORCEINLINE IR_ERROR ParseVarUInt1(Stream& s, varuint1& target) { IR_ERROR err; target = static_cast<varuint1>(DecodeLEB128(s, err, 1, false)); return err; }
  ...
  IR_ERROR ParseByteArray(Stream& s, ByteArray& section, bool nullterminate)
  {
    IR_ERROR err = ParseVarUInt32(s, section.n_bytes);
    if(err < 0)
      return err;
  ...
  IR_ERROR ParseIdentifier(Stream& s, ByteArray& section)
  {
  ...
  IR_ERROR ParseInitializer(Stream& s, Instruction& ins)
  {
  ...
  IR_ERROR ParseTableDesc(Stream& s, TableDesc& t)
  {
  ...
  IR_ERROR ParseGlobalDesc(Stream& s, GlobalDesc& g)
  {
  ...
  IR_ERROR ParseGlobalDecl(Stream& s, GlobalDecl& g)
  {
  ...
  IR_ERROR ParseImport(Stream& s, Import& i)
  {
  ...
  IR_ERROR ParseExport(Stream& s, Export& e)
  {
  ...
  IR_ERROR ParseInstruction(Stream& s, Instruction& ins)
  {
  ...
  IR_ERROR ParseTableInit(Stream& s, TableInit& init, Module& m)
  {
  ...
  IR_ERROR ParseFunctionBody(Stream& s, FunctionBody& f)
  {
  ...
  IR_ERROR ParseNameSectionLocal(Stream& s, size_t num, const char**& target)
  {
    IR_ERROR err;
  ...
  IR_ERROR ParseNameSection(Stream& s, size_t end, Module& m)
  {
  ...
  IR_ERROR ParseModule(Stream& s, Module& m, ByteArray name)
  {
    m = { 0 };
    ...
    tmemcpy(m.name.bytes, m.name.n_bytes, name.bytes, name.n_bytes);
  ...
  IR_ERROR ParseExportFixup(Module& m)
  {

...
include ksamd64.inc
        subttl  "_innative_internal_env_memcpy"
...
;*******************************************************************************
        ...
        extrn   _innative_internal_env__memcpy_nt_iters:qword     ; defined in cpu_disp.c
...
; and restored for exception handling.
        ...
        NESTED_ENTRY _innative_internal_env_memcpy_repmovs, _TEXT
        ...
        NESTED_END _innative_internal_env_memcpy_repmovs, _TEXT


; Main memmove/memcpy routine


        public _innative_internal_env_memmove

        LEAF_ENTRY_ARG3 _innative_internal_env_memcpy, _TEXT, dst:ptr byte, src:ptr byte, count:dword

        OPTION PROLOGUE:NONE, EPILOGUE:NONE

        _innative_internal_env_memmove = _innative_internal_env_memcpy
 ...
 CopyUp:
        ...
        test    _innative_internal_env__favor, 1 SHL __FAVOR_ENFSTRG ; check for ENFSTRG (enhanced fast strings)
...
XmmCopyLargeTest:
        ...
        cmp     r9, _innative_internal_env__memcpy_nt_iters   ; threshold defined by cpu_disp.c
...
XmmMovReturn:
        ...
        LEAF_END _innative_internal_env_memcpy, _TEXT

...
ifdef MEM_MOVE
        _MEM_     equ <_innative_internal_env_memmove>
else  ; MEM_MOVE
        _MEM_     equ <_innative_internal_env_memcpy>
endif  ; MEM_MOVE
...
CopyUpLargeMov:
        bt      _innative_internal_env__favor, __FAVOR_ENFSTRG        ; check if Enhanced Fast Strings is supported
...
AtomChk:
        ; Is Atom supported?
        bt      _innative_internal_env__favor, __FAVOR_ATOM

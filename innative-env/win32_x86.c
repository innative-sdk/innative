// Constructed from the assembly code shipped with Visual Studio to implement 64-bit math on 32-bit x86
// The assembly in this file is Copyright (c) Microsoft Corporation. All rights reserved.

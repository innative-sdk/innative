...
include ksamd64.inc
        ...
        subttl  "_innative_internal_env_memcmp"
;***
...
;*******************************************************************************
        ...
        LEAF_ENTRY_ARG3 _innative_internal_env_memcmp, _TEXT, buf1:ptr byte, buf2:ptr byte, count:dword
...
mcmp40: mov     al, [rcx]               ; compare single byte
        ...
        dec     r8                      ; decrement reaming byte count
...
mcmp_adjust0:                           ;
        ...
        LEAF_END _innative_internal_env_memcmp, _TEXT

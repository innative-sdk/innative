...
include ksamd64.inc
        subttl  "_innative_internal_env_memset"
;***
...
; and restored for exception handling.
        ...
        NESTED_ENTRY _innative_internal_env_memset_repmovs, _TEXT
        ...
        NESTED_END _innative_internal_env_memset_repmovs, _TEXT


; Main memset routine


        LEAF_ENTRY_ARG3 _innative_internal_env_memset, _TEXT, buf:ptr byte, value:byte, count:dword
...
msetTab16:
        ...
        LEAF_END _innative_internal_env_memset, _TEXT

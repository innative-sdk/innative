...
namespace innative {
  ...
  void ValidateBlockSignature(const Instruction& ins, Stack<varsint7>& values, varsint64 sig, Environment& env, Module* m);
  ...
  void ValidateFunctionBody(varuint32 idx, const FunctionBody& body, Environment& env, Module* m);

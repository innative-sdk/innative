...
enum ERROR_CODE
{
  ...
  ERR_FATAL_DUPLICATE_MODULE_NAME = -0x20,
  ...
  ERR_WAT_BAD_ESCAPE = -0x010023,
  ERR_WAT_EXPECTED_KIND = -0x010024,

  // Runtime errors
  ERR_RUNTIME_INIT_ERROR = -0x100000,
  ERR_RUNTIME_TRAP = -0x100001,
  ERR_RUNTIME_ASSERT_FAILURE = -0x100002,
};
...
enum ENVIRONMENT_FLAGS
{
  ...
  ENV_DLL = (1 << 3),
  ENV_ENABLE_WAT = (1 << 4),
  ENV_OPTIMIZE_INLINE = (1 << 5),
  ENV_OPTIMIZE_ANALYSIS = (1 << 6),
  ENV_OPTIMIZE_VECTORIZE = (1 << 7),

...
enum IN_ERROR
{
  ...
  ERR_FATAL_FORMAT_ERROR,
  ERR_FATAL_DEBUG_OBJ_ERROR,
  ERR_FATAL_DEBUG_ERROR,
  ...
  ERR_FATAL_SECTION_SIZE_MISMATCH,
  ERR_FATAL_FUNCTION_SIZE_MISMATCH,
  ERR_FATAL_MULTIPLE_START_SECTIONS,
  ERR_FATAL_DATA_COUNT_MISMATCH,
  ...
  ERR_INVALID_DATA_INDEX,
  ERR_INVALID_ELEMENT_INDEX,
  ...
  ERR_SHARED_MEMORY_MAXIMUM_MISSING,
  ERR_SHARED_MEMORY_MISMATCH,
  ERR_IF_ELSE_MISMATCH,
  ERR_END_MISMATCH,
  ERR_SIGNATURE_MISMATCH,
  ERR_EXPECTED_ELSE_INSTRUCTION,
  ERR_ILLEGAL_C_IMPORT,
  ERR_JIT_COMPILE_FAILURE,
  ERR_JIT_TARGET_MACHINE_FAILURE,
  ERR_JIT_DATA_LAYOUT_ERROR,
  ERR_JIT_LINK_PROCESS_FAILURE,
  ERR_JIT_LINK_FAILURE,
  ERR_MISSING_DATA_COUNT_SECTION,
